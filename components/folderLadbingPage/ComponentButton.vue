<template>
    <div class="d-flex justify-center mb-5 pb-5 mb-md-0 pb-md-0 px-3 px-md-0" v-if="props.indexNumber == 0">
        <router-link to="/"
    ...
    <div class="d-flex justify-center divWithdBlack" v-if="props.indexNumber == 1">
        <router-link to="/"
